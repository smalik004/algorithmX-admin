...
//         points: [
//           {
//             ...SmallWidgetsChartOption.options.annotations.points[0],
//             marker: {
//               ...SmallWidgetsChartOption.options.annotations.points[0].marker,
...
//           colorStops:
//             SmallWidgetsChartOption.options.fill.gradient.colorStops.map(
//               (item) => {
...
//               points: [
//                 {
//                   ...item.options.annotations.points[0],
//                   marker: {
//                     ...item.options.annotations.points[0].marker,
//                     fillColor: chartData.color,
//                   },
//                 },
//               ],
